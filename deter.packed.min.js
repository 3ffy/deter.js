...
break
default:e=[0,0,1,0,.5,.5,.5,0,0,.5,1,.5,.5,1,.5,.5,0,1]}for(var r=0;r<e.length;r++)e[r]=e[r]*t
return e},i=function(e,t,r,o){var i=parseInt(t.substr(0,1),16),c=parseInt(t.substr(1,1),16),b=7&parseInt(t.substr(2,1),16),d=Math.PI/2,l=d*(3&parseInt(t.substr(3,1),16)),u=d*(3&parseInt(t.substr(4,1),16)),g=parseInt(t.substr(5,1),16)%2,f=parseInt(t.substr(6,2),16),h=parseInt(t.substr(8,2),16),v=parseInt(t.substr(10,2),16),p=parseInt(t.substr(12,2),16),x=parseInt(t.substr(14,2),16),m=parseInt(t.substr(16,2),16),y=r/3,w=r,k=a(i,y)
e.fillStyle="rgb("+f+","+h+","+v+")",o===!1&&(l=0),s(e,k,0,0,l,0,y),s(e,k,w,0,l,90,y),s(e,k,w,w,l,180,y),s(e,k,0,w,l,270,y),o===!1&&(u=0)
var C=a(c,y)
e.fillStyle="rgb("+p+","+x+","+m+")",s(e,C,0,y,u,0,y),s(e,C,2*y,0,u,90,y),s(e,C,3*y,2*y,u,180,y),s(e,C,y,3*y,u,270,y)
var z=n(b,y)
e.fillStyle=g>0&&(Math.abs(f-p)>127||Math.abs(h-x)>127||Math.abs(v-m)>127)?"rgb("+p+","+x+","+m+")":"rgb("+f+","+h+","+v+")",s(e,z,y,y,0,0,y)}
...
break
default:d.callback=b}return e(this).on(d.events,d.selectorDelegated,d,s),this},e.fn.identicon=function(t,a,o){if(settings=e.extend({size:65},o),"auto"==settings.size){var s=e(this)
settings.size=Math.min(s.width(),s.height())}return this.each(r?function(){var r=e(this)
