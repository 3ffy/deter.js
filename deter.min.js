...
break
default:d.callback=c}return e(this).on(d.events,d.selectorDelegated,d,s),this},e.fn.identicon=function(t,a,o){if(settings=e.extend({size:65},o),"auto"==settings.size){var s=e(this)
