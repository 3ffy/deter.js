...
return r.r=Math.abs(255-e.r),r.g=Math.abs(1==t?255-(e.r+e.b)/2:255-e.g),r.b=Math.abs(255-e.b),r},getClosestColor:function(t,r,o){"object"!=typeof r&&(rgbSeed1={r:0,g:0,b:0}),"object"!=typeof o&&(o={r:255,g:255,b:255})
...
var s,n,i=e.length
for(s=0;i>s;s++)n=e.substr(0,s+1),a.push(o(n,t))}return a}}),e.fn.deter=function(t,a){var o,d=e.extend({sequence:!1,opacity:1,canevasSize:"auto",addDeterExtraMarkups:!0,getContent:null,events:"keyup",selectorDelegated:null,selectorDescendant:null,addClass:"",textColorMode:"default",target:null},a)
if("function"==typeof t?(o="custom",d.sequence=!1):o="string"==typeof t&&"default"!=t?t:"box-identicon","box-identicon"==o&&0==r&&(o="box-color"),1==d.addDeterExtraMarkups){var l
this.each(function(){l=" "+d.addClass+" deter-mode-"+o,("box-identicon"==o||"box-color"==o)&&(l+=" deter-behaviour-box"),e(this).addClass("deter-password").wrap('<div class="deter-container'+l+'"></div>'),"body"!=o&&"border"!=o&&"background"!=o&&e('<span class="deter-fingerprint"></span>').insertAfter(e(this))})}var u=null===d.selectorDelegated?this:d.selectorDelegated
switch(o){case"custom":d.callback=t
break
...
break
default:d.callback=c}return e(u).on(d.events,d.selectorDescendant,d,s),this},e.fn.identicon=function(t,a,o){if(settings=e.extend({size:65},o),"auto"==settings.size){var s=e(this)
...
a.identicon(b.md5,b.hex,{rotate:!0,size:i})}),setTimeout(function(){e(".div.deter-container.deter-behaviour-box > .deter-password").trigger("blur")},100)})}(jQuery)