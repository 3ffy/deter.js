...
r.boxTitle="If this picture is not the one you use to see, your password is misspelled.",r.autofillDrawIdenticon=!0,r.wrapWithMarkup=function(t,a,r){if("string"!=typeof a)throw"Param 'mode' is mandatory."
...
$elem.css("color","rgb("+s.r+","+s.g+","+s.b+")")}},c=function(t,a,r){var o=e(this).siblings("span.deter-fingerprint")
o.css("background-color",""==r?"":a.hex)},d=function(t,a,r){var o=e(this).siblings("span.deter-fingerprint")
...
var s=e.rgbToXyz(r.rgbRaw),n=e.xyzToLab(s),i=e.rgbToXyz(a),c=e.xyzToLab(i),d=e.rgbToXyz(o),b=e.xyzToLab(d),l=Math.abs(c.l-n.l)+Math.abs(c.a-n.a)+Math.abs(c.b-n.b),u=Math.abs(b.l-n.l)+Math.abs(b.a-n.a)+Math.abs(b.b-n.b)
return u>=l?a:o},getFurtherColor:function(t,a,r){"object"!=typeof a&&(a={r:0,g:0,b:0}),"object"!=typeof r&&(r={r:255,g:255,b:255})
var o=e.rgbToXyz(t),s=e.xyzToLab(o),n=e.rgbToXyz(a),i=e.xyzToLab(n),c=e.rgbToXyz(r),d=e.xyzToLab(c),b=Math.abs(i.l-s.l)+Math.abs(i.a-s.a)+Math.abs(i.b-s.b),l=Math.abs(d.l-s.l)+Math.abs(d.a-s.a)+Math.abs(d.b-s.b)
return b>l?a:r},strToColor:function(e,t,a){var r
if(a!==!0)r=o(e,t)
else{r=[]
var s,n,i=e.length
for(s=0;i>s;s++)n=e.substr(0,s+1),r.push(o(n,t))}return r}}),e.fn.deter=function(t,r){var o,b=e.extend({sequence:!1,opacity:1,canevasSize:"auto",addDeterExtraMarkups:!0,getContent:null,events:"keyup",selectorDelegated:null,addClass:"",textColorMode:"default",target:null},r)
switch("function"==typeof t?(o="custom",b.sequence=!1):o="string"==typeof t&&"default"!=t?t:"box-identicon","box-identicon"==o&&0==a&&(o="box-color"),null===b.selectorDelegated&&1==b.addDeterExtraMarkups&&e.deter.wrapWithMarkup(this,o,b.addClass),o){case"custom":b.callback=t
break
case"border":b.callback=n
break
case"background":b.callback=i
break
case"box-color":b.callback=c
break
default:b.callback=d}return e(this).on(b.events,b.selectorDelegated,b,s),this},e.fn.identicon=function(t,r,o){if(settings=e.extend({size:65},o),"auto"==settings.size){var s=e(this),n=s.width(),i=s.height()
...
a="object"==typeof a?a:{}
var o=void 0===a.value?r.siblings(".deter-password").val():a.value,s=void 0===a.opacity?1:a.opacity,n=void 0===a.sequence?!1:a.sequence,i=void 0===a.canevasSize?"auto":a.canevasSize,c=e.strToColor(o,s,n)
r.identicon(c.md5,c.hex,{rotate:!0,size:i})})}),1==e.deter.autofillDrawIdenticon&&e(window).load(function(){var t=/webkit/.test(navigator.userAgent.toLowerCase())
e("div.deter-container.deter-mode-box-identicon > .deter-password").each(function(){var a=e(this)
if(1==t&&a.filter(":-webkit-autofill"))var r=setInterval(function(){1==a.is(":visible")&&setTimeout(function(){""!=a.val()&&a.trigger("repaint"),window.clearInterval(r)},100)},300)
else setTimeout(function(){""!=a.val()&&a.trigger("repaint")},100)})})}(jQuery)